...
#  First define the class ids, confidence and bounding box

while True:
    success, img = cap.read()
    # Confidence Threshold is the percentage where the object can surly detect that
    ...
    # a variables that is class id but if we need more than 1 we use the zip function
    if len(classIds) != 0:
